...
import { OwnerTaskEvidenceSection } from "@/components/owner/OwnerTaskEvidenceSection";
  ...
  return (
    <section className="border-t border-[var(--border)] py-8">
      ...
      <div className="mt-6 grid gap-8 xl:grid-cols-[1fr_0.92fr]">
        ...
        {detailTab === "tasks" ? (
          <OwnerTaskEvidenceSection
            projectId={dashboard.projectId}
            priorityCount={dashboard.dashboard.summary.priorityCount}
            tasksData={tasksData}
