    ...
    <div className="grid gap-4 md:grid-cols-3">
      ...
      >
        <div className="space-y-1 text-sm text-zinc-900">
          ...
          <div className="text-xs text-zinc-600">{gbp?.primary_category ?? "—"}</div>
          <div className="pt-2">
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="mt-1 flex items-end gap-2">
                <div className="text-4xl font-black leading-none md:text-5xl">
                  {realisticTarget90d ?? "—"}
                </div>
            ...
            <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-3 text-xs text-zinc-700">
              ...
              <div className="mt-1">
                ...
                days <span className="text-zinc-500">(changes only when gap changes)</span>
              </div>
              <div className="mt-1">
